/*
 * @Author: Satya
 * @Date: 2020-06-11 15:54:44
 * @Last Modified by: Satya
 * @Last Modified time: 2020-06-15 16:19:40
 * doc: 控制分类所有积木块创建及配置
 */
...
Blockly.Blocks["control_forever"] = {
  ...
  init: function () {
    this.jsonInit({
      ...
      message1: "%1", // Statement // 内嵌
      message2: "%1", // Icon // c形底部，右侧icon
      lastDummyAlign2: "RIGHT",
      args0: [
        {
          type: "field_image",
          src:
            Blockly.mainWorkspace.options.pathToMedia + "control/forever.png",
          width: 48,
          height: 48,
        },
      ],
  ...
  init: function () {
    this.jsonInit({
      ...
      args0: [
        {
          type: "field_image",
          src: Blockly.mainWorkspace.options.pathToMedia + "control/repeat.png",
          width: 48,
          height: 48,
        },
        {
  ...
  init: function () {
    this.jsonInit({
      ...
      args0: [
        {
          type: "field_image",
          src: Blockly.mainWorkspace.options.pathToMedia + "control/wait.png",
          width: 48,
          height: 48,
        },
        {
