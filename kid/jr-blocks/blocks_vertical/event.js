/*
 * @Author: Satya
 * @Date: 2020-06-11 15:12:19
 * @Last Modified by: Satya
 * @Last Modified time: 2020-06-15 16:27:29
 * doc: 事件分类下所有积木块创建及配置
 */
  ...
  init: function () {
    this.jsonInit({
      ...
      args0: [
        {
          type: "field_image",
          src: Blockly.mainWorkspace.options.pathToMedia + "events/start.png",
          width: 48,
          height: 48,
          alt: "flag",
        },
      ...
      args0: [
        {
          type: "field_image",
          src:
            Blockly.mainWorkspace.options.pathToMedia + "events/broadcast.png",
          width: 48,
          height: 48,
        },
        {
