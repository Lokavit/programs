/*
 * @Author: Satya
 * @Date: 2020-06-15 13:40:02
 * @Last Modified by: Satya
 * @Last Modified time: 2020-06-15 13:44:40
 * doc:可视地拖动块的方法
 */
...
/**
 * 块拖动器的类.当通过鼠标或触摸拖动块时，它将在工作空间中移动块.
...
Blockly.BlockDragger = function (block, workspace) {
  ...
  /**
   * 此块及其后代上的所有图标（注释，警告和更改符）的列表。如果图标是打开的，则移动图标将移动从其延伸的气泡.
   * @type {Array.<!Object>}
   * @private
   */
...
/**
 * 列出此块及其后代上的所有图标（注释，警告和更改符）的列表。如果图标是打开的，则移动图标将移动从其延伸的气泡.
 * @param {!Blockly.BlockSvg} block 被拖动的根块.
 * @return {!Array.<!Object>} 所有图标及其位置的列表.
 * @private
 */
...
/**
 * 开始拖动一个块。 这包括将其移动到拖动表面.
 * @param {!goog.math.Coordinate} currentDragDeltaXY 指针从鼠标向下的位置移动的距离，以像素为单位.
 * @package
 */
