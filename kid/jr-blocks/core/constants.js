/*
 * @Author: Satya
 * @Date: 2020-05-29 16:52:51
 * @Last Modified by: Satya
 * @Last Modified time: 2020-06-15 13:38:37
 * doc:
 *  追加音乐分类
 */
/**
 * @fileoverview Blockly 常量.
...
/**
 * 从弹出按钮开始拖动/滚动之前，鼠标必须移动的像素数。 因为拖动意图是在到达时确定的，所以它大于Blockly.DRAG_RADIUS，因此拖动方向更加清晰
 */
...
/** 连接已突出显示时，连接之间的最大不对齐关系使其卡在一起 */
Blockly.CONNECTING_SNAP_RADIUS = 68;

/**
 * 当前的连接偏好 How much to prefer staying connected to the current connection over moving to
