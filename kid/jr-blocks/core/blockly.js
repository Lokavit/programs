/*
 * @Author: Satya
 * @Date: 2020-06-06 10:08:50
 * @Last Modified by: Satya
 * @Last Modified time: 2020-06-15 11:32:38
 * doc:适用于Blockly的核心JavaScript库
 */
...
/**
 * 调整SVG图像的大小以完全填充其容器
 * 当视图实际更改大小时（例如，在更改窗口大小/更改设备方向时）调用此函数
 * 在内容更改时（例如，在添加或删除块时）调整工作区的大小。记录SVG图像的高度/宽度
...
/**
 * 从Blockly Developer Tools可能生成的JSON块定义数组中定义块。
