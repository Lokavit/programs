/*
 * @Author: Satya
 * @Date: 2020-11-14 15:10:19
 * @Last Modified by: Satya
 * @Last Modified time: 2020-11-14 15:11:48
 * doc: 程序块
 */
...
Blockly.Blocks["procedures_defnoreturn"] = {
  ...
  init: function () {
    ...
    this.appendDummyInput()
      .appendField(KidBlocks.Msg.PROCEDURES_DEFNORETURN_TITLE)
    ...
    if (
      ...
      KidBlocks.Msg.PROCEDURES_DEFNORETURN_COMMENT
    ) {
      this.setCommentText(KidBlocks.Msg.PROCEDURES_DEFNORETURN_COMMENT);
    }
    this.setStyle("procedure_blocks");
    this.setTooltip(KidBlocks.Msg.PROCEDURES_DEFNORETURN_TOOLTIP);
    this.setHelpUrl(KidBlocks.Msg.PROCEDURES_DEFNORETURN_HELPURL);
    this.arguments_ = [];
  ...
  /**
   * 从此函数定义中添加或删除语句块.
   * @param {boolean} hasStatements 如果需要语句块则为真.
   * @this {Blockly.Block}
   */
  setStatements_: function (hasStatements) {
    ...
    if (hasStatements) {
      this.appendStatementInput("STACK").appendField(
        KidBlocks.Msg.PROCEDURES_DEFNORETURN_DO
      );
  ...
  updateParams_: function () {
    ...
    if (this.arguments_.length) {
      paramString = `${
        KidBlocks.Msg.PROCEDURES_BEFORE_PARAMS
      } ${this.arguments_.join(", ")}`;
    }
    // params字段是基于突变的确定性字段，无需触发更改事件.
  ...
  customContextMenu: function (options) {
    ...
    option.text = KidBlocks.Msg.PROCEDURES_CREATE_DO.replace("%1", name);
    ...
    if (!this.isCollapsed()) {
      for (var i = 0; i < this.argumentVarModels_.length; i++) {
        ...
        argOption.text = KidBlocks.Msg.VARIABLES_SET_CREATE_GET.replace(
          "%1",
          argVar.name
        );
...
Blockly.Blocks["procedures_defreturn"] = {
  ...
  init: function () {
    ...
    nameField.setSpellcheck(false);
    this.appendDummyInput()
      .appendField(KidBlocks.Msg.PROCEDURES_DEFRETURN_TITLE)
      .appendField(nameField, "NAME")
      .appendField("", "PARAMS");
    this.appendValueInput("RETURN")
      .setAlign(Blockly.ALIGN_RIGHT)
      .appendField(KidBlocks.Msg.PROCEDURES_DEFRETURN_RETURN);
    this.setMutator(new Blockly.Mutator(["procedures_mutatorarg"]));
    if (
      (this.workspace.options.comments ||
        (this.workspace.options.parentWorkspace &&
          this.workspace.options.parentWorkspace.options.comments)) &&
      KidBlocks.Msg.PROCEDURES_DEFRETURN_COMMENT
    ) {
      this.setCommentText(KidBlocks.Msg.PROCEDURES_DEFRETURN_COMMENT);
    }
    this.setStyle("procedure_blocks");
    this.setTooltip(KidBlocks.Msg.PROCEDURES_DEFRETURN_TOOLTIP);
    this.setHelpUrl(KidBlocks.Msg.PROCEDURES_DEFRETURN_HELPURL);
    this.arguments_ = [];
    this.argumentVarModels_ = [];
    this.setStatements_(true);
    this.statementConnection_ = null;
...
Blockly.Blocks["procedures_mutatorcontainer"] = {
  ...
  init: function () {
    this.appendDummyInput().appendField(
      KidBlocks.Msg.PROCEDURES_MUTATORCONTAINER_TITLE
    );
    this.appendStatementInput("STACK");
    this.appendDummyInput("STATEMENT_INPUT")
      .appendField(KidBlocks.Msg.PROCEDURES_ALLOW_STATEMENTS)
      .appendField(new Blockly.FieldCheckbox("TRUE"), "STATEMENTS");
    this.setStyle("procedure_blocks");
    this.setTooltip(KidBlocks.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP);
...
Blockly.Blocks["procedures_mutatorarg"] = {
  ...
  init: function () {
    ...
    this.appendDummyInput()
      .appendField(KidBlocks.Msg.PROCEDURES_MUTATORARG_TITLE)
      .appendField(field, "NAME");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setStyle("procedure_blocks");
    this.setTooltip(KidBlocks.Msg.PROCEDURES_MUTATORARG_TOOLTIP);
    this.contextMenu = false;
...
Blockly.Blocks["procedures_callnoreturn"] = {
  ...
  init: function () {
    ...
    this.setNextStatement(true);
    this.setStyle("procedure_blocks");
    // 工具提示是在renameProcedure中设置的.
    this.setHelpUrl(KidBlocks.Msg.PROCEDURES_CALLNORETURN_HELPURL);
    this.arguments_ = [];
    this.argumentVarModels_ = [];
  ...
  renameProcedure: function (oldName, newName) {
    if (Blockly.Names.equals(oldName, this.getProcedureCall())) {
      ...
      var baseMsg = this.outputConnection
        ? KidBlocks.Msg.PROCEDURES_CALLRETURN_TOOLTIP
        : KidBlocks.Msg.PROCEDURES_CALLNORETURN_TOOLTIP;
    ...
    if (topRow) {
      if (this.arguments_.length) {
        if (!this.getField("WITH")) {
          topRow.appendField(
            KidBlocks.Msg.PROCEDURES_CALL_BEFORE_PARAMS,
            "WITH"
          );
          topRow.init();
        }
  ...
  customContextMenu: function (options) {
    ...
    var option = { enabled: true };
    option.text = KidBlocks.Msg.PROCEDURES_HIGHLIGHT_DEF;
    var name = this.getProcedureCall();
...
Blockly.Blocks["procedures_callreturn"] = {
  ...
  init: function () {
    ...
    this.setHelpUrl(KidBlocks.Msg.PROCEDURES_CALLRETURN_HELPURL);
    this.arguments_ = [];
    this.quarkConnections_ = {};
    this.quarkIds_ = null;
    this.previousEnabledState_ = true;
...
Blockly.Blocks["procedures_ifreturn"] = {
  ...
  init: function () {
    this.appendValueInput("CONDITION")
      .setCheck("Boolean")
      .appendField(KidBlocks.Msg.CONTROLS_IF_MSG_IF);
    this.appendValueInput("VALUE").appendField(
      KidBlocks.Msg.PROCEDURES_DEFRETURN_RETURN
    );
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setStyle("procedure_blocks");
    this.setTooltip(KidBlocks.Msg.PROCEDURES_IFRETURN_TOOLTIP);
    this.setHelpUrl(KidBlocks.Msg.PROCEDURES_IFRETURN_HELPURL);
  ...
  onchange: function (_e) {
    ...
    if (legal) {
      ...
      this.setWarningText(KidBlocks.Msg.PROCEDURES_IFRETURN_WARNING);
