...
/**
 * @fileoverview 复选框字段.  Checked or not checked.
...
/**
 * 复选框字段的类.
 * @param {string} state 字段的初始状态 ('TRUE' or 'FALSE').
 * @param {Function=} opt_validator 选择新选项时执行的功能。 它唯一的参数是新的复选框状态。 如果它返回一个值，则它将变为新的复选框状态，除非该值为null，在这种情况下，更改将被中止.
 * @extends {Blockly.Field}
 * @constructor
 */
Blockly.FieldCheckbox = function (state, opt_validator) {
  console.warn("是否用到FieldCheckbox:", state, opt_validator);
...
Blockly.FieldCheckbox.fromJson = function (options) {
  console.warn("是否用到FieldCheckbox.fromJson:", options);
