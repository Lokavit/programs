...
Blockly.Block.prototype.jsonInit = function (json) {
  ...
  // 如果 json中包含 checkbox布局
  if (json["checkboxInFlyout"] !== undefined) {
    console.warn("json中包含checkboxInFlyout");
...
/**
 * 设置弹出菜单中该块旁边是否有一个复选框.
 * @param {boolean} hasCheckbox 如果此块应具有一个复选框，则为True.
 */
Blockly.Block.prototype.setCheckboxInFlyout = function (hasCheckbox) {
  console.warn("设置弹出菜单中该块旁边是否有一个复选框");
  this._checkboxInFlyout = hasCheckbox;
};

/**
 * 获取弹出菜单中此块旁边是否有一个复选框.
 * @return {boolean} 如果此块应具有一个复选框，则为True.
 */
Blockly.Block.prototype.hasCheckboxInFlyout = function () {
  console.warn("获取弹出菜单中此块旁边是否有一个复选框");
  return this._checkboxInFlyout;
};
