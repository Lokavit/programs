...
/** @export */ Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "不能删除变量“%1”，因为它是功能“%2”定义的一部分";
...
/** @export */ Blockly.Msg.COLOUR_BLEND_HELPURL =
  "http://meyerweb.com/eric/tools/color-blend/"; // untranslated
/** @export */ Blockly.Msg.COLOUR_BLEND_RATIO = "比例";
/** @export */ Blockly.Msg.COLOUR_BLEND_TITLE = "混合";
/** @export */ Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "用一个给定的比率(0.0-1.0)混合两种颜色。";
/** @export */ Blockly.Msg.COLOUR_PICKER_HELPURL =
  "https://zh.wikipedia.org/wiki/颜色";
...
/** @export */ Blockly.Msg.COLOUR_RGB_HELPURL =
  "http://www.december.com/html/spec/colorper.html"; // untranslated
/** @export */ Blockly.Msg.COLOUR_RGB_RED = "红色";
/** @export */ Blockly.Msg.COLOUR_RGB_TITLE = "颜色";
/** @export */ Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "通过指定红色、绿色和蓝色的量创建一种颜色。所有的值必须在0和100之间。";
/** @export */ Blockly.Msg.CONTROLS_FLOW_STATEMENTS_HELPURL =
...
/** @export */ Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "继续下一次循环";
/** @export */ Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "中断包含它的循环。";
/** @export */ Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "跳过这个循环的剩余部分，并继续下一次迭代。";
/** @export */ Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "警告：此块仅可用于在一个循环内。";
/** @export */ Blockly.Msg.CONTROLS_FOREACH_HELPURL =
  "https://github.com/google/blockly/wiki/Loops#for-each"; // untranslated
/** @export */ Blockly.Msg.CONTROLS_FOREACH_TITLE = "为每个项目 %1 在列表中 %2";
/** @export */ Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "遍历每个列表中的项目，将变量“%1”设定到该项中，然后执行某些语句。";
/** @export */ Blockly.Msg.CONTROLS_FOR_HELPURL =
  "https://github.com/google/blockly/wiki/Loops#count-with"; // untranslated
/** @export */ Blockly.Msg.CONTROLS_FOR_TITLE =
  "使用 %1 从范围 %2 到 %3 每隔 %4";
/** @export */ Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "从起始数到结尾数中取出变量“%1”的值，按指定的时间间隔，执行指定的块。";
/** @export */ Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP =
  "在if语句块中增加一个条件。";
/** @export */ Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  "添加一个最终的，包括所有情况的节到if块中。";
/** @export */ Blockly.Msg.CONTROLS_IF_HELPURL =
  "https://github.com/google/blockly/wiki/IfElse"; // untranslated
/** @export */ Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "增加、删除或重新排列各节来重新配置“if”块。";
...
/** @export */ Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "如果值为真，则执行第一块语句。否则，则执行第二块语句。";
/** @export */ Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "如果第一个值为真，则执行第一块的语句。否则，如果第二个值为真，则执行第二块的语句。";
/** @export */ Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "如果第一个值为真，则执行第一块对语句。否则，如果第二个值为真，则执行语句的第二块。如果没有值为真，则执行最后一块的语句。";
/** @export */ Blockly.Msg.CONTROLS_REPEAT_HELPURL =
...
/** @export */ Blockly.Msg.CONTROLS_WHILEUNTIL_HELPURL =
...
/** @export */ Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "只要值为假，执行一些语句。";
...
/** @export */ Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "删除“%2”变量的%1用途么？";
...
/** @export */ Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST =
  "返回列表中的第一个项目。";
/** @export */ Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "返回在列表中的指定位置的项。";
/** @export */ Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST =
  "返回列表中的最后一项。";
/** @export */ Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM =
  "随机返回列表中的一个项目。";
/** @export */ Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST =
  "移除并返回列表中的第一个项目。";
/** @export */ Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "移除并返回列表中的指定位置的项。";
/** @export */ Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST =
  "移除并返回列表中的最后一个项目。";
/** @export */ Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM =
  "移除并返回列表中的一个随机项目中。";
/** @export */ Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FIRST =
  "移除列表中的第一项";
/** @export */ Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM =
  "移除在列表中的指定位置的项。";
/** @export */ Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST =
  "移除列表中的最后一项";
/** @export */ Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM =
  "删除列表中的一个随机的项。";
...
/** @export */ Blockly.Msg.LISTS_GET_SUBLIST_HELPURL =
...
/** @export */ Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END =
  "从倒数#取得子列表";
...
/** @export */ Blockly.Msg.LISTS_INDEX_OF_HELPURL =
...
/** @export */ Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "返回在列表中的第一/最后一个匹配项的索引值。如果找不到项目则返回%1。";
/** @export */ Blockly.Msg.LISTS_INLIST = "在列表中";
/** @export */ Blockly.Msg.LISTS_ISEMPTY_HELPURL =
...
/** @export */ Blockly.Msg.LISTS_LENGTH_HELPURL =
...
/** @export */ Blockly.Msg.LISTS_REPEAT_HELPURL =
...
/** @export */ Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "建立包含指定重复次数的值的列表。";
/** @export */ Blockly.Msg.LISTS_REVERSE_HELPURL =
...
/** @export */ Blockly.Msg.LISTS_SET_INDEX_HELPURL =
...
/** @export */ Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST =
  "在列表的起始处添加该项。";
/** @export */ Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM =
  "插入在列表中指定位置的项。";
/** @export */ Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_LAST =
  "将该项追加到列表的末尾。";
/** @export */ Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM =
  "在列表中随机插入项。";
/** @export */ Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FIRST =
  "设置列表中的第一个项目。";
...
/** @export */ Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM =
  "设置列表中一个随机的项目。";
/** @export */ Blockly.Msg.LISTS_SORT_HELPURL =
...
/** @export */ Blockly.Msg.LOGIC_COMPARE_HELPURL =
  "https://zh.wikipedia.org/wiki/不等";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "如果两个输入结果相等，则返回真。";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "如果第一个输入结果比第二个大，则返回真。";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "如果第一个输入结果大于或等于第二个输入结果，则返回真。";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "如果第一个输入结果比第二个小，则返回真。";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "如果第一个输入结果小于或等于第二个输入结果，则返回真。";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "如果两个输入结果不相等，则返回真。";
/** @export */ Blockly.Msg.LOGIC_NEGATE_HELPURL =
  "https://github.com/google/blockly/wiki/Logic#not";
/** @export */ Blockly.Msg.LOGIC_NEGATE_TITLE = "非%1";
/** @export */ Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "如果输入结果为假，则返回真；如果输入结果为真，则返回假。";
/** @export */ Blockly.Msg.LOGIC_NULL = "空";
/** @export */ Blockly.Msg.LOGIC_NULL_HELPURL =
...
/** @export */ Blockly.Msg.LOGIC_OPERATION_HELPURL =
  "https://github.com/google/blockly/wiki/Logic#logical-operations"; // untranslated
/** @export */ Blockly.Msg.LOGIC_OPERATION_OR = "或";
/** @export */ Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "如果两个输入结果都为真，则返回真。";
/** @export */ Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "如果至少有一个输入结果为真，则返回真。";
/** @export */ Blockly.Msg.LOGIC_TERNARY_CONDITION = "测试";
/** @export */ Blockly.Msg.LOGIC_TERNARY_HELPURL =
...
/** @export */ Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "检查“test”中的条件。如果条件为真，则返回“if true”的值，否则，则返回“if false”的值。";
/** @export */ Blockly.Msg.MATH_ADDITION_SYMBOL = "+"; // untranslated
/** @export */ Blockly.Msg.MATH_ARITHMETIC_HELPURL =
  "https://zh.wikipedia.org/wiki/算术";
/** @export */ Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_ADD = "返回两个数字的和。";
/** @export */ Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_DIVIDE =
  "返回两个数字的商。";
/** @export */ Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MINUS =
  "返回两个数字的区别。";
/** @export */ Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY =
  "返回两个数字的乘积。";
/** @export */ Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "返回第一个数的第二个数次幂。";
/** @export */ Blockly.Msg.MATH_CHANGE_HELPURL =
  "https://zh.wikipedia.org/wiki/加法";
/** @export */ Blockly.Msg.MATH_CHANGE_TITLE = "更改 %1 从 %2";
/** @export */ Blockly.Msg.MATH_CHANGE_TOOLTIP = "将一个数添加到变量“%1”。";
/** @export */ Blockly.Msg.MATH_CONSTANT_HELPURL =
  "https://zh.wikipedia.org/wiki/数学常数";
/** @export */ Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "返回一个常见常量：π (3.141…)、e (2.718…)、φ (1.618…)、平方根 (1.414…)、开平方根 (0.707…)或∞ (infinity)。";
/** @export */ Blockly.Msg.MATH_CONSTRAIN_HELPURL =
  "https://en.wikipedia.org/wiki/Clamping_(graphics)"; // untranslated
/** @export */ Blockly.Msg.MATH_CONSTRAIN_TITLE =
  "限制数字 %1 介于 (低) %2 到 (高) %3";
/** @export */ Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "限制数字介于两个指定的数字之间";
...
/** @export */ Blockly.Msg.MATH_IS_TOOLTIP =
  "如果数字是偶数、奇数、非负整数、正数、负数或如果它可被某数字整除，则返回真或假。";
/** @export */ Blockly.Msg.MATH_IS_WHOLE = "为整数";
/** @export */ Blockly.Msg.MATH_MODULO_HELPURL =
...
/** @export */ Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "返回列表中的数值的平均值。";
...
/** @export */ Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  "返回列表中的最常见的项的列表。";
/** @export */ Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM =
  "从列表中返回一个随机的元素。";
/** @export */ Blockly.Msg.MATH_ONLIST_TOOLTIP_STD_DEV = "返回列表的标准偏差。";
/** @export */ Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM =
  "返回列表中的所有数字的和。";
/** @export */ Blockly.Msg.MATH_POWER_SYMBOL = "^"; // untranslated
/** @export */ Blockly.Msg.MATH_RANDOM_FLOAT_HELPURL =
  "https://zh.wikipedia.org/wiki/随机数生成器";
/** @export */ Blockly.Msg.MATH_RANDOM_FLOAT_TITLE_RANDOM = "随机分数";
/** @export */ Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  "返回介于（包含）0.0到1.0之间的随机数。";
/** @export */ Blockly.Msg.MATH_RANDOM_INT_HELPURL =
  "https://zh.wikipedia.org/wiki/随机数生成器";
/** @export */ Blockly.Msg.MATH_RANDOM_INT_TITLE = "从 %1 到 %2 之间的随机整数";
/** @export */ Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "返回两个指定的范围（含）之间的随机整数。";
/** @export */ Blockly.Msg.MATH_ROUND_HELPURL =
  "https://zh.wikipedia.org/wiki/数值修约";
...
/** @export */ Blockly.Msg.MATH_SINGLE_HELPURL =
  "https://zh.wikipedia.org/wiki/平方根";
...
/** @export */ Blockly.Msg.MATH_TRIG_HELPURL =
...
/** @export */ Blockly.Msg.MATH_TRIG_TOOLTIP_COS =
  "返回指定角度的余弦值(非弧度）。";
/** @export */ Blockly.Msg.MATH_TRIG_TOOLTIP_SIN =
  "返回指定角度的正弦值(非弧度）。";
/** @export */ Blockly.Msg.MATH_TRIG_TOOLTIP_TAN =
  "返回指定角度的正切值(非弧度）。";
...
/** @export */ Blockly.Msg.PROCEDURES_CALLNORETURN_HELPURL =
  "https://zh.wikipedia.org/wiki/子程序";
/** @export */ Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "运行用户定义的函数“%1”。";
/** @export */ Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  "https://zh.wikipedia.org/wiki/子程序";
/** @export */ Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
...
/** @export */ Blockly.Msg.PROCEDURES_DEFNORETURN_HELPURL =
  "https://zh.wikipedia.org/wiki/子程序";
/** @export */ Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE = "做点什么";
/** @export */ Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE = "至";
/** @export */ Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  "创建一个不带输出值的函数。";
/** @export */ Blockly.Msg.PROCEDURES_DEFRETURN_HELPURL =
  "https://zh.wikipedia.org/wiki/子程序";
/** @export */ Blockly.Msg.PROCEDURES_DEFRETURN_RETURN = "返回";
/** @export */ Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP =
  "创建一个有输出值的函数。";
/** @export */ Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
  "警告: 此函数具有重复参数。";
/** @export */ Blockly.Msg.PROCEDURES_HIGHLIGHT_DEF = "突出显示函数定义";
/** @export */ Blockly.Msg.PROCEDURES_IFRETURN_HELPURL =
  "http://c2.com/cgi/wiki?GuardClause";
/** @export */ Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP =
  "如果值为真，则返回第二个值。";
/** @export */ Blockly.Msg.PROCEDURES_IFRETURN_WARNING =
  "警告: 仅在定义函数内可使用此块。";
...
/** @export */ Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "添加、删除或重新排此函数的输入。";
...
/** @export */ Blockly.Msg.TEXT_APPEND_HELPURL =
...
/** @export */ Blockly.Msg.TEXT_CHANGECASE_HELPURL =
...
/** @export */ Blockly.Msg.TEXT_CHANGECASE_TOOLTIP =
  "在不同大小写下复制并返回这段文字。";
...
/** @export */ Blockly.Msg.TEXT_CHARAT_HELPURL =
...
/** @export */ Blockly.Msg.TEXT_COUNT_HELPURL =
  "https://github.com/google/blockly/wiki/Text#counting-substrings";
/** @export */ Blockly.Msg.TEXT_COUNT_MESSAGE0 = "将%1计算在%2之内";
/** @export */ Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "计算在一些其他文本中，部分文本重现了多少次。";
/** @export */ Blockly.Msg.TEXT_CREATE_JOIN_ITEM_TOOLTIP =
  "将一个项添加到文本中。";
/** @export */ Blockly.Msg.TEXT_CREATE_JOIN_TITLE_JOIN = "加入";
/** @export */ Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
...
/** @export */ Blockly.Msg.TEXT_GET_SUBSTRING_HELPURL =
...
/** @export */ Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST =
  "取得一段字串自第一个字符";
/** @export */ Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  "取得一段字串自倒数第#个字符";
/** @export */ Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START =
  "取得一段字串自#";
/** @export */ Blockly.Msg.TEXT_GET_SUBSTRING_TAIL = "空白";
/** @export */ Blockly.Msg.TEXT_GET_SUBSTRING_TOOLTIP = "返回指定的部分文本。";
/** @export */ Blockly.Msg.TEXT_INDEXOF_HELPURL =
...
/** @export */ Blockly.Msg.TEXT_INDEXOF_OPERATOR_LAST =
  "寻找最后一个出现的文本";
/** @export */ Blockly.Msg.TEXT_INDEXOF_TITLE = "在文本%1 %2 %3中";
/** @export */ Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "返回在第二个字串中的第一/最后一个匹配项的索引值。如果未找到则返回%1。";
/** @export */ Blockly.Msg.TEXT_ISEMPTY_HELPURL =
  "https://github.com/google/blockly/wiki/Text#checking-for-empty-text"; // untranslated
/** @export */ Blockly.Msg.TEXT_ISEMPTY_TITLE = "%1是空的";
/** @export */ Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "如果提供的文本为空，则返回真。";
...
/** @export */ Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "通过串起任意数量的项以建立一段文字。";
/** @export */ Blockly.Msg.TEXT_LENGTH_HELPURL =
  "https://github.com/google/blockly/wiki/Text#text-modification"; // untranslated
/** @export */ Blockly.Msg.TEXT_LENGTH_TITLE = "%1的长度";
/** @export */ Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  "返回提供文本的字母数（包括空格）。";
/** @export */ Blockly.Msg.TEXT_PRINT_HELPURL =
  "https://github.com/google/blockly/wiki/Text#printing-text"; // untranslated
/** @export */ Blockly.Msg.TEXT_PRINT_TITLE = "打印%1";
/** @export */ Blockly.Msg.TEXT_PRINT_TOOLTIP =
  "打印指定的文字、数字或其他值。";
/** @export */ Blockly.Msg.TEXT_PROMPT_HELPURL =
...
/** @export */ Blockly.Msg.TEXT_PROMPT_TYPE_TEXT = "输入文本并显示提示消息";
/** @export */ Blockly.Msg.TEXT_REPLACE_HELPURL =
  "https://github.com/google/blockly/wiki/Text#replacing-substrings";
/** @export */ Blockly.Msg.TEXT_REPLACE_MESSAGE0 = "在%3中，将%1替换为%2";
/** @export */ Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "在某些其他文本中，替换部分文本的所有事件。";
/** @export */ Blockly.Msg.TEXT_REVERSE_HELPURL =
...
/** @export */ Blockly.Msg.TEXT_TEXT_HELPURL =
  "https://zh.wikipedia.org/wiki/字符串";
/** @export */ Blockly.Msg.TEXT_TEXT_TOOLTIP = "一个字母、单词或一行文本。";
/** @export */ Blockly.Msg.TEXT_TRIM_HELPURL =
...
/** @export */ Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "复制这段文字的同时删除两端多余的空格。";
...
/** @export */ Blockly.Msg.VARIABLES_GET_HELPURL =
...
/** @export */ Blockly.Msg.VARIABLES_SET_HELPURL =
  "https://github.com/google/blockly/wiki/Variables#set"; // untranslated
/** @export */ Blockly.Msg.VARIABLES_SET_TOOLTIP =
  "设置此变量，以使它和输入值相等。";
/** @export */ Blockly.Msg.VARIABLE_ALREADY_EXISTS = "已存在名为“%1”的变量。";
/** @export */ Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "名叫“%1”的变量已存在，但作为另一个变量类型“%2”存在。";
/** @export */ Blockly.Msg.PROCEDURES_DEFRETURN_TITLE =
  Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE;
/** @export */ Blockly.Msg.CONTROLS_IF_IF_TITLE_IF =
  Blockly.Msg.CONTROLS_IF_MSG_IF;
/** @export */ Blockly.Msg.CONTROLS_WHILEUNTIL_INPUT_DO =
  Blockly.Msg.CONTROLS_REPEAT_INPUT_DO;
/** @export */ Blockly.Msg.CONTROLS_IF_MSG_THEN =
  Blockly.Msg.CONTROLS_REPEAT_INPUT_DO;
/** @export */ Blockly.Msg.CONTROLS_IF_ELSE_TITLE_ELSE =
  Blockly.Msg.CONTROLS_IF_MSG_ELSE;
/** @export */ Blockly.Msg.PROCEDURES_DEFRETURN_PROCEDURE =
  Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE;
/** @export */ Blockly.Msg.LISTS_GET_SUBLIST_INPUT_IN_LIST =
  Blockly.Msg.LISTS_INLIST;
/** @export */ Blockly.Msg.LISTS_GET_INDEX_INPUT_IN_LIST =
  Blockly.Msg.LISTS_INLIST;
/** @export */ Blockly.Msg.MATH_CHANGE_TITLE_ITEM =
  Blockly.Msg.VARIABLES_DEFAULT_NAME;
/** @export */ Blockly.Msg.PROCEDURES_DEFRETURN_DO =
  Blockly.Msg.PROCEDURES_DEFNORETURN_DO;
/** @export */ Blockly.Msg.CONTROLS_IF_ELSEIF_TITLE_ELSEIF =
  Blockly.Msg.CONTROLS_IF_MSG_ELSEIF;
/** @export */ Blockly.Msg.LISTS_GET_INDEX_HELPURL =
  Blockly.Msg.LISTS_INDEX_OF_HELPURL;
/** @export */ Blockly.Msg.CONTROLS_FOREACH_INPUT_DO =
  Blockly.Msg.CONTROLS_REPEAT_INPUT_DO;
/** @export */ Blockly.Msg.LISTS_SET_INDEX_INPUT_IN_LIST =
  Blockly.Msg.LISTS_INLIST;
/** @export */ Blockly.Msg.CONTROLS_FOR_INPUT_DO =
  Blockly.Msg.CONTROLS_REPEAT_INPUT_DO;
/** @export */ Blockly.Msg.LISTS_CREATE_WITH_ITEM_TITLE =
  Blockly.Msg.VARIABLES_DEFAULT_NAME;
/** @export */ Blockly.Msg.TEXT_APPEND_VARIABLE =
  Blockly.Msg.VARIABLES_DEFAULT_NAME;
/** @export */ Blockly.Msg.TEXT_CREATE_JOIN_ITEM_TITLE_ITEM =
  Blockly.Msg.VARIABLES_DEFAULT_NAME;
/** @export */ Blockly.Msg.LISTS_INDEX_OF_INPUT_IN_LIST =
  Blockly.Msg.LISTS_INLIST;
/** @export */ Blockly.Msg.PROCEDURES_DEFRETURN_COMMENT =
...
/** @export */ Blockly.Msg.SHOWCODE_SHOW = "监看程式码(主控台)  即时";
