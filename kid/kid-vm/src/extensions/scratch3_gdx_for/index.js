...
//         // Setup device
//         this._device = device;
//         this._device.keepValues = false; // todo: 在更新Vernier godirect模块后可能会删除
...
//       value = Utility.radToDeg(value) * -1;
//     }
...
//       default:
//         console.warn(`unknown gesture value in whenGesture: ${args.GESTURE}`);
//         return false;
//     }
//   }
...
//       default:
//         console.warn(`Unknown direction in getTilt: ${direction}`);
//     }
//   }
...
//       default:
//         console.warn(`Unknown direction in getSpinSpeed: ${args.DIRECTION}`);
//     }
//   }
...
//       default:
//         console.warn(`Unknown direction in getAcceleration: ${args.DIRECTION}`);
//     }
//   }
