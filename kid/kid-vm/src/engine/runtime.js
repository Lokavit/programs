...
const defaultBlockPackages = require("../vm-blocks.js");
...
class Runtime extends EventEmitter {
  constructor() {
    ...
    // 注册并初始化"IO devices"，用于处理 I/O 相关数据的容器.
    /** @type {Object.<string, Object>} */
    this.ioDevices = {
    ...
    return {
      json: {
        ...
        outputShape: menuInfo.acceptReporters
          ? KidBlocksConstants.OUTPUT_SHAPE_ROUND
          : KidBlocksConstants.OUTPUT_SHAPE_SQUARE,
        args0: [
          {
            type: "field_dropdown",
            name: menuName,
  ...
  _convertBlockForScratchBlocks(blockInfo, categoryInfo) {
    ...
    const mutation = blockInfo.isDynamic
      ? `<mutation blockInfo="${Utility.xmlEscape(
