/*
 * @Author: Satya
 * @Date: 2020-07-21 13:42:08
 * @Last Modified by: Satya
 * @Last Modified time: 2020-11-27 16:01:51
 * doc:事件类积木块
 */
...
class EventBlocks {
  ...
  getPrimitives() {
    return {
      pro_event_whentouchingobject: this.touchingObject,
      pro_event_broadcast: this.broadcast,
      pro_event_broadcastandwait: this.broadcastAndWait,
      pro_event_whengreaterthan: this.hatGreaterThanPredicate,
    };
  }
