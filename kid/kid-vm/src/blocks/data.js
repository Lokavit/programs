class DataBlocks {
  ...
  getPrimitives() {
    return {
      pro_data_variable: this.getVariable,
      pro_data_setvariableto: this.setVariableTo,
      pro_data_changevariableby: this.changeVariableBy,
      pro_data_hidevariable: this.hideVariable,
      pro_data_showvariable: this.showVariable,
      pro_data_listcontents: this.getListContents,
      pro_data_addtolist: this.addToList,
      pro_data_deleteoflist: this.deleteOfList,
      pro_data_deletealloflist: this.deleteAllOfList,
      pro_data_insertatlist: this.insertAtList,
      pro_data_replaceitemoflist: this.replaceItemOfList,
      pro_data_itemoflist: this.getItemOfList,
      pro_data_itemnumoflist: this.getItemNumOfList,
      pro_data_lengthoflist: this.lengthOfList,
      pro_data_listcontainsitem: this.listContainsItem,
      pro_data_hidelist: this.hideList,
      pro_data_showlist: this.showList,
    };
  }
  ...
  addToList(args, util) {
    const list = util.target.lookupOrCreateList(args.LIST.id, args.LIST.name);
    if (list.value.length < DataBlocks.LIST_ITEM_LIMIT) {
  ...
  insertAtList(args, util) {
    ...
    const listLimit = DataBlocks.LIST_ITEM_LIMIT;
