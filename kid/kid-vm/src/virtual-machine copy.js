...
//     // /** 验证 */
//     // const validationPromise = new Promise((resolve, reject) => {
//     //   console.log("验证 使用parser解析");
//     //   const validate = require("./parser/index");
//     //   // 下面的第二个参数false为验证器指示输入应作为整个项目（而不是单个sprite）进行解析/验证
//     //   // 第三个参数为回调函数
//     //   /**
//     //    * 启用parser解析
//     //    * 参数一:传入待解析的数据(项目JSON或元素的……)
//     //    * 参数二:false表示项目数据;true表示单个元素数据
//     //    * 参数三:回调函数，返回Promise结果
//     //    */
//     //   // validate(data, false, (error, res) => {
//     //   //   if (error) return reject(error);
//     //   //   resolve(res);
//     //   // });
//     //   resolve(validate(data, false));
//     // }).catch((error) => {
//     //   // 由于输入似乎不是SB1File，因此引发原始错误.
...
//     console.log(
//       "vm.js deserializeProject() 反序列化项目 ,运行该函数时，先清理当前runtime",
//       projectJSON,
//       zip
//     );
...
//       console.log("virtual-machine.js 反序列化项目中的 deserializePromise");
...
//         const sb3 = require("./serialization/sb3");
//         console.log(
//           "virtual-machine.js 反序列化项目中的 反序列化 sb3.调用其专属反序列化",
//           projectJSON,
//           runtime,
//           zip
//         );
...
//       console.log("准备调用installTargets安装所有解析的targets");
...
//         console.log("准备执行this.runtime.addTarget", target);
...
//   /**
//    * Set the storage module for the VM/runtime 关联存储管理器, gui项目中(reducers/vm.js)调用
...
//   /**
//    * set the current locale and builtin messages for the VM 多语言支持
