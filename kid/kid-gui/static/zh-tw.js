/*
 * @Author: Satya
 * @Date: 2020-08-02 09:08:22
 * @Last Modified by: Satya
 * @Last Modified time: 2020-08-31 17:25:28
 * doc:语言文件 中文繁体
 */
const ZH_TW = {
  /** 新增当前语言对象 属性及属性值 */
  "gui.costumeLibrary.backdropLib": "背景库",
  "gui.spriteLibrary.spriteLib": "角色库",
  "gui.menuBar.saveAsDraft": "儲存草稿",
  "gui.menuBar.pushProject": "发布專案",
  /** 以下为原版 当前语言对象 属性及属性值 */
  ...
  "gui.unsupportedBrowser.notRecommended":
    "很抱歉，這個版本的瀏覽器無法支援。建議你改用其它的，像是 Google Chrome、Mozilla Firefox、Microsoft Edge、Apple Safari。",
  "gui.unsupportedBrowser.description":
    "很抱歉，這個瀏覽器無法支援。建議你改用其它的，像是 Google Chrome、Mozilla Firefox、Microsoft Edge、Apple Safari。",
  "gui.unsupportedBrowser.back": "返回",
  "gui.unsupportedBrowser.previewfaq":
    "若要進一步瞭解，請至 {previewFaqLink}。",
  ...
  "gui.connection.unavailable.installscratchlink": "確定你已經安裝並執行 Link",
  ...
  "gui.crashMessage.description":
    "很抱歉，看起來 崩潰了，錯誤已自動回報給 團隊，請重新整理你的頁面，再試一次吧！",
  ...
  "gui.menuBar.seeProjectPage": "切換到專案",
  ...
  "gui.telemetryOptIn.label": "回報統計數據以協助改善",
  "gui.telemetryOptIn.body1":
    "團隊希望能深入瞭解 在世界各地的使用情況。如果可以的話，希望你能允許 將你的使用情形紀錄下來並發送給 團隊。",
  "gui.telemetryOptIn.body2":
    "我們會蒐集的資訊包含了語言的選擇、積木的使用量，還有一些事件，像是儲存、載入、上傳專案。我們保證不會收集任何個人資訊。你可以觀看我們的 {privacyPolicyLink} 以進一步瞭解相關訊息。",
  ...
  "gui.alerts.cloudInfo":
    "注意，雲端變數目前只支援數字，不能存取文字等其它符號。{learnMoreLink}",
  ...
  "gui.howtos.make-music.step_MakeBeatBox":
    "選擇角色 Microphone（麥克風）& 用驚喜按鈕產生 Beatbox",
  ...
  "gui.extension.ev3.connectingMessage":
    "正在連接，請確定 EV3 主機上的 Pin 碼已設為 1234。",
  ...
  // "gui.sharedMessages.costume": "造型 %s",
...
// window.ZH_TW = ZH_TW;
// console.log("挂载语言包 中繁:", window.ZH_TW);
