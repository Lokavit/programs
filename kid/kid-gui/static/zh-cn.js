/*
 * @Author: Satya
 * @Date: 2020-08-02 09:05:43
 * @Last Modified by: Satya
 * @Last Modified time: 2020-12-04 11:43:10
 * doc:语言文件 中文简体
 */
const ZH_CN = {
  /** 新增当前语言对象 属性及属性值 */
  ...
  "gui.menuBar.saveAsDraft": "草稿",
  "gui.menuBar.pushProject": "发布",
  /** 以下为原版 当前语言对象 属性及属性值 */
  "gui.alerts.lostPeripheralConnection": "与{extensionName}的连接已断开。",
  ...
  "gui.unsupportedBrowser.notRecommended":
    "我们十分抱歉，不支持您正在使用的浏览器，我们建议您升级到我们所支持的浏览器的最新版本，例如Chrome、火狐、Edge或者Safari。",
  "gui.unsupportedBrowser.description":
    "我们十分抱歉，并不支持您当前使用的浏览器，我们建议您升级到我们所支持的浏览器的最新版，例如Chrome、火狐、Edge或者Safari。",
  ...
  "gui.connection.unavailable.installscratchlink": "确保 Link已安装并正在运行",
  ...
  "gui.crashMessage.description":
    "很抱歉，出故障了。这个问题已经自动报告给开发团队。请刷新页面再试试。",
  ...
  "gui.menuBar.seeProjectPage": "作品库",
  ...
  "gui.telemetryOptIn.label": "统计使用情况并发送给",
  "gui.telemetryOptIn.body1":
    "允许自动发送使用情况信息给团队，帮助我们了解在全世界的使用情况。",
  ...
  "gui.gui.defaultProjectTitle": "作品",
...
// window.ZH_CN = ZH_CN;
// console.log("挂载语言包 中简:", window.ZH_CN);
