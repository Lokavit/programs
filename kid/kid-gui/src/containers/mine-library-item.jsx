...
import LibraryItemComponent from "../components/mine-library-item/library-item.jsx";
...
class LibraryItem extends React.PureComponent {
  ...
  render() {
    ...
    //如果是声音就显示图标
    // const iconURL = this.props.type == 4 ? this.props.iconRawURL :  `http://assets.program.leadersir.net/material/${iconMd5}`;
    const iconURL =
      this.props.type == 4
        ? this.props.iconRawURL
        : `${GLOBAL_URL.ASSET_MATERIAL}${iconMd5}`;
    return (
