...
class CustomProcedures extends React.Component {
  ...
  setBlocks(blocksRef) {
    ...
    const oldDefaultToolbox = RETURN_KID_VERISON()
      ? KidProBlocks.Blocks.defaultToolbox
      : KidJrBlocks.Blocks.defaultToolbox;

    if (RETURN_KID_VERISON()) {
      KidProBlocks.Blocks.defaultToolbox = null;
      this.workspace = KidProBlocks.inject(this.blocks, workspaceConfig);
      KidProBlocks.Blocks.defaultToolbox = oldDefaultToolbox;
    } else {
      KidJrBlocks.Blocks.defaultToolbox = null;
      this.workspace = KidJrBlocks.inject(this.blocks, workspaceConfig);
      KidJrBlocks.Blocks.defaultToolbox = oldDefaultToolbox;
    }
