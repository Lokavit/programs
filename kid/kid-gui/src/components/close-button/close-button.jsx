...
const CloseButton = (props) => (
  ...
  >
    {props.buttonType === "back" ? (
      <img className={styles.backIcon} src={GLOBAL_URL.ASSET_ICON_BACK} />
    ) : (
      <img
...
closeIcons = {
  [CloseButton.COLOR_NEUTRAL]: GLOBAL_URL.ASSET_ICON_CLOSE,
  [CloseButton.COLOR_GREEN]: GLOBAL_URL.ASSET_ICON_CLOSE, // TODO: temporary, need green icon
  [CloseButton.COLOR_ORANGE]: GLOBAL_URL.ASSET_ICON_CLOSE_ORANGE,
};
