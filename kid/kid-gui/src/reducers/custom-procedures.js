const ACTIVATE_CUSTOM_PROCEDURES =
  "pro-gui/custom-procedures/ACTIVATE_CUSTOM_PROCEDURES";
const DEACTIVATE_CUSTOM_PROCEDURES =
  "pro-gui/custom-procedures/DEACTIVATE_CUSTOM_PROCEDURES";
const SET_CALLBACK = "pro-gui/custom-procedures/SET_CALLBACK";
