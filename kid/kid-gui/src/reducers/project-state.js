...
const DONE_CREATING_COPY = "pro-gui/project-state/DONE_CREATING_COPY";
const DONE_CREATING_NEW = "pro-gui/project-state/DONE_CREATING_NEW";
const DONE_FETCHING_DEFAULT = "pro-gui/project-state/DONE_FETCHING_DEFAULT";
const DONE_FETCHING_WITH_ID = "pro-gui/project-state/DONE_FETCHING_WITH_ID";
const DONE_LOADING_VM_TO_SAVE = "pro-gui/project-state/DONE_LOADING_VM_TO_SAVE";
const DONE_LOADING_VM_WITH_ID = "pro-gui/project-state/DONE_LOADING_VM_WITH_ID";
const DONE_LOADING_VM_WITHOUT_ID =
  "pro-gui/project-state/DONE_LOADING_VM_WITHOUT_ID";
const DONE_REMIXING = "pro-gui/project-state/DONE_REMIXING";
const DONE_UPDATING = "pro-gui/project-state/DONE_UPDATING";
const DONE_UPDATING_BEFORE_COPY =
  "pro-gui/project-state/DONE_UPDATING_BEFORE_COPY";
const DONE_UPDATING_BEFORE_NEW =
  "pro-gui/project-state/DONE_UPDATING_BEFORE_NEW";
const RETURN_TO_SHOWING = "pro-gui/project-state/RETURN_TO_SHOWING";
const SET_PROJECT_ID = "pro-gui/project-state/SET_PROJECT_ID";
const START_AUTO_UPDATING = "pro-gui/project-state/START_AUTO_UPDATING";
const START_CREATING_NEW = "pro-gui/project-state/START_CREATING_NEW";
const START_ERROR = "pro-gui/project-state/START_ERROR";
const START_FETCHING_NEW = "pro-gui/project-state/START_FETCHING_NEW";
const START_LOADING_VM_FILE_UPLOAD =
  "pro-gui/project-state/START_LOADING_FILE_UPLOAD";
const START_MANUAL_UPDATING = "pro-gui/project-state/START_MANUAL_UPDATING";
const START_REMIXING = "pro-gui/project-state/START_REMIXING";
const START_UPDATING_BEFORE_CREATING_COPY =
  "pro-gui/project-state/START_UPDATING_BEFORE_CREATING_COPY";
const START_UPDATING_BEFORE_CREATING_NEW =
  "pro-gui/project-state/START_UPDATING_BEFORE_CREATING_NEW";

const defaultProjectId = "0"; // 默认项目的硬编码ID
...
const getIsFetchingWithoutId = (loadingState) =>
  // LOADING_VM_FILE_UPLOAD 是一项荣誉提取，因为没有文件上传的提取步骤
...
const reducer = function (state, action) {
  ...
  switch (action.type) {
    case DONE_CREATING_NEW:
      // 我们需要设置项目ID，因为我们刚刚在服务器上创建了新项目.
      // 无需加载，我们应该已经在vm中存储了数据.
...
const createProject = function () {
  console.log("redux createProject");
  return {
...
const onLoadedProject = (loadingState, canSave, success) => {
  console.log("加载完成项目:", loadingState, canSave, success);
  if (success) {
    switch (loadingState) {
      case LoadingState.LOADING_VM_WITH_ID:
        alert("in state: " + loadingState);
        return {
