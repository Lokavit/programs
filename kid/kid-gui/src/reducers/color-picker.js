const ACTIVATE_COLOR_PICKER = "pro-gui/color-picker/ACTIVATE_COLOR_PICKER";
const DEACTIVATE_COLOR_PICKER = "pro-gui/color-picker/DEACTIVATE_COLOR_PICKER";
const SET_CALLBACK = "pro-gui/color-picker/SET_CALLBACK";
