 ...
 * @Last Modified time: 2020-12-07 19:02:52
 * doc:kid-pro版本 页面初始化
...
/** 七牛云 kid/js/v/pro专属js文件 */
GLOBAL_URL.ASSET_KID_VERTICAL_PRO = `${GLOBAL_URL.ASSET_KID_JS_VERSION}vertical_pro.js`;
GLOBAL_URL.ASSET_KID_BLOCKS_PRO = `${GLOBAL_URL.ASSET_KID_JS_VERSION}blocks_pro.js`;

/** 七牛云 kid/js/v/kid-storage.js */
GLOBAL_URL.ASSET_KID_STORAGE = `${GLOBAL_URL.ASSET_KID_JS_VERSION}kid-storage.js`;

/** 七牛云 kid/js/v/ react打包出来的一些文件 */
...
document.write(`
    ...
    <!-- pro-blocks lib -->
    <script src="${GLOBAL_URL.ASSET_KID_VERTICAL_PRO}"></script>
    <script src="${GLOBAL_URL.ASSET_KID_BLOCKS_PRO}"></script>
    <!-- kid-stroage lib -->
