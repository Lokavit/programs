/*
 * @Author: Satya
 * @Date: 2020-08-27 19:22:10
 * @Last Modified by: Satya
 * @Last Modified time: 2020-12-07 19:02:46
 * doc:kid-jr版本 页面初始化
 * 动态加载js及css，document.write()为暂行方案
 * 优先判断当前的协议模式：根据协议模式，切换不同的资源请求地址
 * 全局URL。定义本项目的所有URL相关，便于更改
 *  命名规范：
...
/** 每次版本迭代需要替换的js文件夹
 * 该文件夹以版本号命名 v0.0.0.0.0
 * version + 主版本号 + 大功能模块添加 + 小功能添加及BUG修复 + BUG修复时的迭代
 */
const VERSION = `v1.0.3.16`;

/** 全局 URL对象，挂载项目所需资源URL */
...
/** 七牛云 kid/js下 对应版本文件夹中的js文件，该版本文件夹在本文件顶部定义 */
GLOBAL_URL.ASSET_KID_JS_VERSION = `${GLOBAL_URL.ASSET_KID}js/${VERSION}/`;

/** 七牛云 kid/js/v/语言包  */
GLOBAL_URL.ASSET_KID_L10N_EN = `${GLOBAL_URL.ASSET_KID_JS_VERSION}en.js`;
GLOBAL_URL.ASSET_KID_L10N_CN = `${GLOBAL_URL.ASSET_KID_JS_VERSION}zh-cn.js`;
GLOBAL_URL.ASSET_KID_L10N_TW = `${GLOBAL_URL.ASSET_KID_JS_VERSION}zh-tw.js`;

/** 七牛云 kid/js/v/启动器 */
GLOBAL_URL.ASSET_KID_LAUNCHER = `${GLOBAL_URL.ASSET_KID_JS_VERSION}launcher.js`;

/** 七牛云 kid/js/v/jr专属js文件 */
GLOBAL_URL.ASSET_KID_VERTICAL_JR = `${GLOBAL_URL.ASSET_KID_JS_VERSION}vertical_jr.js`;
GLOBAL_URL.ASSET_KID_BLOCKS_JR = `${GLOBAL_URL.ASSET_KID_JS_VERSION}blocks_jr.js`;

/** 七牛云 kid/js/v/kid-storage.js */
GLOBAL_URL.ASSET_KID_STORAGE = `${GLOBAL_URL.ASSET_KID_JS_VERSION}kid-storage.js`;

/** react打包出来的一些文件 */
GLOBAL_URL.ASSET_KID_LIB_KID = `${GLOBAL_URL.ASSET_KID_JS_VERSION}lib.kid.js`;
GLOBAL_URL.ASSET_KID_LIB_UTIL = `${GLOBAL_URL.ASSET_KID_JS_VERSION}lib.util.js`;
GLOBAL_URL.ASSET_KID_LIB_REACT = `${GLOBAL_URL.ASSET_KID_JS_VERSION}lib.react.js`;
GLOBAL_URL.ASSET_KID_VENDORS = `${GLOBAL_URL.ASSET_KID_JS_VERSION}vendors.js`;
GLOBAL_URL.ASSET_KID_COMMON = `${GLOBAL_URL.ASSET_KID_JS_VERSION}common.js`;
GLOBAL_URL.ASSET_KID_GUI = `${GLOBAL_URL.ASSET_KID_JS_VERSION}gui.js`;
...
/** 默认头像 */
// GLOBAL_URL.ASSET_AVATAR_DEFAULT = `https://scratch.steam.leadersir.com/assets/img/forum/avatar_default.png`;
 ...
 */
/** 扩展库预览界面相关资源 基础URL */
GLOBAL_URL.ASSET_EXTENSION_LIBRARY = `${GLOBAL_URL.ASSET_KID}extensions/`;
/** music */
GLOBAL_URL.ASSET_EXTENSION_ICON_URL_MUSIC = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}music.png`;
GLOBAL_URL.ASSET_EXTENSION_INSET_ICON_URL_MUSIC = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}music-small.svg`;
/** pen */
GLOBAL_URL.ASSET_EXTENSION_ICON_URL_PEN = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}pen.png`;
GLOBAL_URL.ASSET_EXTENSION_INSET_ICON_URL_PEN = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}pen-small.svg`;
/** video sensing */
GLOBAL_URL.ASSET_EXTENSION_ICON_URL_VIDEO_SENSING = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}video-sensing.png`;
GLOBAL_URL.ASSET_EXTENSION_INSET_ICON_URL_VIDEO_SENSING = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}video-sensing-small.svg`;

/** text to speech */
GLOBAL_URL.ASSET_EXTENSION_ICON_URL_TEXT_TO_SPEECH = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}text2speech.png`;
GLOBAL_URL.ASSET_EXTENSION_INSET_ICON_URL_TEXT_TO_SPEECH = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}text2speech-small.svg`;

/** translate */
GLOBAL_URL.ASSET_EXTENSION_ICON_URL_TRANSLATE = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}translate.png`;
GLOBAL_URL.ASSET_EXTENSION_INSET_ICON_URL_TRANSLATE = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}translate-small.png`;

/** Makey Makey */
GLOBAL_URL.ASSET_EXTENSION_ICON_URL_MAKEY_MAKEY = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}makeymakey.png`;
GLOBAL_URL.ASSET_EXTENSION_INSET_ICON_URL_MAKEY_MAKEY = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}makeymakey-small.svg`;

/** micro:bit */
GLOBAL_URL.ASSET_EXTENSION_ICON_URL_MICROBIT = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}microbit.png`;
GLOBAL_URL.ASSET_EXTENSION_INSET_ICON_URL_MICROBIT = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}microbit-small.svg`;
GLOBAL_URL.ASSET_EXTENSION_CONNECTION_ICON_URL_MICROBIT = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}microbit-illustration.svg`;

/** LEGO MINDSTORMS EV3 */
GLOBAL_URL.ASSET_EXTENSION_ICON_URL_LEGO_V3 = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}ev3.png`;
GLOBAL_URL.ASSET_EXTENSION_INSET_ICON_URL_LEGO_V3 = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}ev3-small.svg`;
GLOBAL_URL.ASSET_EXTENSION_CONNECTION_ICON_URL_LEGO_V3 = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}ev3-hub-illustration.svg`;

/** LEGO BOOST */
GLOBAL_URL.ASSET_EXTENSION_ICON_URL_LEGO_BOOST = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}boost.png`;
GLOBAL_URL.ASSET_EXTENSION_INSET_ICON_URL_LEGO_BOOST = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}boost-small.svg`;
GLOBAL_URL.ASSET_EXTENSION_CONNECTION_ICON_URL_LEGO_BOOST = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}boost-illustration.svg`;
GLOBAL_URL.ASSET_EXTENSION_CONNECTION_TIP_ICON_URL_LEGO_BOOST = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}boost-button-illustration.svg`;

/** LEGO Education WeDo 2.0 */
GLOBAL_URL.ASSET_EXTENSION_ICON_URL_LEGO_WEDO2 = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}wedo.png`;
GLOBAL_URL.ASSET_EXTENSION_INSET_ICON_URL_LEGO_WEDO2 = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}wedo-small.svg`;
GLOBAL_URL.ASSET_EXTENSION_CONNECTION_ICON_URL_LEGO_WEDO2 = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}wedo-illustration.svg`;
GLOBAL_URL.ASSET_EXTENSION_CONNECTION_TIP_ICON_URL_LEGO_WEDO2 = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}wedo-button-illustration.svg`;

/** Go Direct Force & Acceleration */
GLOBAL_URL.ASSET_EXTENSION_ICON_URL_GDXFOR = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}gdxfor.png`;
GLOBAL_URL.ASSET_EXTENSION_INSET_ICON_URL_GDXFOR = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}gdxfor-small.svg`;
GLOBAL_URL.ASSET_EXTENSION_CONNECTION_ICON_URL_GDXFOR = `${GLOBAL_URL.ASSET_EXTENSION_LIBRARY}gdxfor-illustration.svg`;

/** 该对象挂载到window下 */
window.GLOBAL_URL = GLOBAL_URL;

/**
 * 以下代码在编译打包时注释，在上传服务器时根据需求解除注释
 */
...
/** kid-gui 通用js */
document.write(`
    <script src="${GLOBAL_URL.ASSET_KID_L10N_EN}"></script>
    <script src="${GLOBAL_URL.ASSET_KID_L10N_CN}"></script>
    <script src="${GLOBAL_URL.ASSET_KID_L10N_TW}"></script>
    <!-- jr-blocks lib -->
    <script src="${GLOBAL_URL.ASSET_KID_VERTICAL_JR}"></script>
    <script src="${GLOBAL_URL.ASSET_KID_BLOCKS_JR}"></script>
    <!-- kid-stroage lib -->
    <script src="${GLOBAL_URL.ASSET_KID_STORAGE}"></script>
    <!-- 启动器 -->
    <script src="${GLOBAL_URL.ASSET_KID_LAUNCHER}"></script>

    <!-- build后的一些文件 -->
    <script src="${GLOBAL_URL.ASSET_KID_LIB_KID}" ></script>
    <script src="${GLOBAL_URL.ASSET_KID_LIB_UTIL}" ></script>
    <script src="${GLOBAL_URL.ASSET_KID_LIB_REACT}" ></script>
    <script src="${GLOBAL_URL.ASSET_KID_VENDORS}" ></script>
    <script src="${GLOBAL_URL.ASSET_KID_COMMON}" ></script>
    <script src="${GLOBAL_URL.ASSET_KID_GUI}" ></script>
    `);
