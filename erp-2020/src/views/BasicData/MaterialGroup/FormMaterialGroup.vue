<template>
  <section v-loading="formLoading">
    <div class="form_header_container">
      <span>物料组 / 表单 {{$route.params.code|FormatFormTitle($route.params.code)}}</span>
        ...
        <div class="form_row">
          ...
          <aside>
            ...
            <el-form-item prop="itemGroupCode">
              <el-input v-model="formData.itemGroupCode" placeholder="请输入物料组编码" clearable :disabled="isDisabled"></el-input>
            </el-form-item>
          </aside>
          <!-- 物料组名称 -->
          <aside>
            <KftLabel label="物料组名称" :isRequired="true"></KftLabel>
            <el-form-item prop="itemGroupName">
              <el-input v-model="formData.itemGroupName" placeholder="请输入物料组名称"></el-input>
            </el-form-item>
          </aside>
          <!-- status 是否可用 -->
          <aside>
