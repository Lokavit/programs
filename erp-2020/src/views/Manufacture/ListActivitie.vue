<template>
  <section :style="{'width':width}" class="modal_list">
    ...
    <el-table v-loading="tableLoading" :data="tableData.content" border highlight-current-row size="mini" :header-cell-style="headerCellStyle" :cell-style="cellStyle" empty-text="请输入项目编码进行查询" stripe>
      ...
      <el-table-column prop="entry" label="编码" show-overflow-tooltip align="center">
      ...
      <el-table-column prop="workArea" label="作业类型" show-overflow-tooltip align="center"></el-table-column>
      <el-table-column prop="workStage" label="作业阶段" show-overflow-tooltip align="center"></el-table-column>
      <el-table-column prop="skill" label="详细工种" show-overflow-tooltip align="center"></el-table-column>
      <el-table-column prop="workSection" label="作业者" show-overflow-tooltip align="center"></el-table-column>
      ...
      <el-table-column prop="plannedStartDate" label="预计开始" show-overflow-tooltip align="center"></el-table-column>
      <el-table-column prop="plannedFinishDate" label="预计完成" show-overflow-tooltip align="center"></el-table-column>
      <!-- <el-table-column prop="effectivePeriod" label="预计净日历" show-overflow-tooltip align="center"></el-table-column> -->
    </el-table>
    <!-- 分页区域 -->
...
export default {
  ...
  computed: {
    ...
    /** 当前窗体标注组 [后台获取所有标注] */
    labels() {
      return this.$store.getters.labels.Activitie.listLbales;
    }
  },
  watch: {},
  created() {},
  ...
  methods: {
    ...
    chooseProject(selectedRow) {
      this.search = {}; // 每次变更项目编码前,清空查询对象的原有属性
